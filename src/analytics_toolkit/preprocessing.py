    ...
    def fit_transform(
        ...
        if categorical_columns is None:
            categorical_columns = list(
                data_copy.select_dtypes(include=["object", "category"]).columns
            )
        ...
        if numerical_columns:
            ...
            data_copy[numerical_columns] = scaler.fit_transform(
                data_copy[numerical_columns]
            )
    ...
    def transform(self, data: pd.DataFrame) -> pd.DataFrame:
        ...
        if "numerical" in self.scalers:
            numerical_columns = [
                ...
                if col in self.scalers["numerical"].feature_names_in_
            ]
            if numerical_columns:
                data_copy[numerical_columns] = self.scalers["numerical"].transform(
                    data_copy[numerical_columns]
                )
